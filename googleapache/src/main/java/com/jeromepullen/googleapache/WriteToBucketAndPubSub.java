...
public class WriteToBucketAndPubSub {
	public static void main(String[] args) {
		...
		pipelineOptions.setJobName("PubSubJobTest");
...
//		pipelineOptions.setGcpTempLocation(null);
		...
		pipeline.apply(Create.of(input)).apply(TextIO.write().to("gs://jerome_apache_beam/input/test").withNumShards(1).withSuffix(".txt"));
